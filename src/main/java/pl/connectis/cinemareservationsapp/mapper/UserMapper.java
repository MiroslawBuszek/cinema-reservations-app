...
import pl.connectis.cinemareservationsapp.model.Permissions;
...
public class UserMapper {
    ...
    public User mapClientFromDTO(UserDTO userDTO) {
        ...
        user.setPermissions(Permissions.CLIENT_ACCESS);
        user.setActive(1);
        return user;
    }
    ...
    public User mapEmployeeFromDTO(UserDTO userDTO) {
        ...
        user.setPermissions(Permissions.EMPLOYEE_ACCESS);
        user.setActive(1);
        return user;
    }
